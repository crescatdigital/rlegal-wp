        ...
        <div class="mx-auto max-w-4xl px-6">
            ...
            <div class="space-y-5">
                ...
                <div class="overflow-hidden rounded-md" data-accordion>
                    <button
                        type="button"
                        class="accordion-trigger w-full flex items-center justify-between px-6 h-[85px] text-left text-[24px] lg:text-[30px] font-semibold text-white transition bg-[#6D3B69]"
